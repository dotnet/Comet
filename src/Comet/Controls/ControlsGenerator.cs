...
[assembly: CometGenerate(typeof(ILabel), $"{nameof(ILabel.Text)}:Value", Namespace = "Comet", ClassName = "Text", Skip = new[] { $"{nameof(ITextStyle.Font)}=this.GetFont(null)" }, DefaultValues = new[] { "MaxLines = 1" })]
