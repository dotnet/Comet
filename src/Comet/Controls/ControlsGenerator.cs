...
[assembly: CometGenerate(typeof(ITextButton), nameof(ITextButton.Text), nameof(IButton.Clicked), ClassName = "Button", Skip = new[] { $"{nameof(ITextButton.TextColor)}:{EnvironmentKeys.Colors.Color}" }, Namespace = "Comet")]
...
[assembly: CometGenerate(typeof(IEntry), nameof(IEntry.Text), nameof(IEntry.Placeholder), nameof(IEntry.Completed), ClassName = "SecureField",DefaultValues =new[] {$"{nameof(ITextInput.MaxLength)}=-1"}, Namespace = "Comet", Skip = new[] { $"{nameof(IEntry.IsPassword)}= true" })]
...
[assembly: CometGenerate(typeof(IEditor), nameof(IEditor.Text), DefaultValues = new[] { $"{nameof(ITextInput.MaxLength)}=-1" }, ClassName="TextEditor", Namespace = "Comet")]
[assembly: CometGenerate(typeof(IEntry), nameof(IEntry.Text), nameof(IEntry.Placeholder), nameof(IEntry.Completed), DefaultValues = new[] { $"{nameof(ITextInput.MaxLength)}=-1" }, ClassName="TextField", Namespace = "Comet")]
