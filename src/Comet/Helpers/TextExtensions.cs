...
namespace Comet
{
	public static partial class TextExtensions
	{
		...
		public static T HorizontalTextAlignment<T>(this T view, Expression<Func<TextAlignment?>> alignment, bool cascades = true) where T : View =>
		...
		public static T VerticalTextAlignment<T>(this T view, Expression<Func<TextAlignment?>> alignment, bool cascades = true) where T : View =>
