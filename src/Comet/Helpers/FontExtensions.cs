...
namespace Comet
{
	public static class FontExtensions
	{
		...
		public static T FontSize<T>(this T view, Expression<Func<double>> value) where T : View
		...
		public static T FontWeight<T>(this T view, Expression<Func<FontWeight>> value) where T : View
		...
		public static T FontFamily<T>(this T view, Expression<Func<string>> value) where T : View
		...
		public static T FontSlant<T>(this T view, Expression<Func<FontSlant>> value) where T : View
