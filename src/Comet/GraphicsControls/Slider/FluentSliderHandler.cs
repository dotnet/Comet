...
//{
//	public class FluentSliderHandler : SliderHandler
//	{
//		public static DrawMapper<FluentSliderHandler, ISlider> SliderDrawMapper = new DrawMapper<FluentSliderHandler, ISlider>(ViewHandler.DrawMapper)
//		{
...
//		public FluentSliderHandler() : base(SliderDrawMapper, null)
//		{
...
//		public static void MapDrawBackground(ICanvas canvas, RectangleF dirtyRect, FluentSliderHandler handler, IView view) => handler.DrawBackground(canvas, dirtyRect);

//		public static void MapDrawTrackProgress(ICanvas canvas, RectangleF dirtyRect, FluentSliderHandler handler, IView view) => handler.DrawTrackProgress(canvas, dirtyRect);

//		public static void MapDrawThumb(ICanvas canvas, RectangleF dirtyRect, FluentSliderHandler handler, IView view) => handler.DrawThumb(canvas, dirtyRect);

//		public static void MapDrawText(ICanvas canvas, RectangleF dirtyRect, FluentSliderHandler handler, IView view) => handler.DrawText(canvas, dirtyRect);
