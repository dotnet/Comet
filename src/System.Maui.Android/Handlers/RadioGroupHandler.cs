...
{
	// TODO: This implementation is basically the same as System.Maui.Android.Handlers.AbstractLaoutHandler.
	...
	class RadioGroupHandler : ARadioGroup, AndroidViewHandler
	{
		...
		public MauiContainerView ContainerView => null;
		...
		public MauiTouchGestureListener GestureListener { get; set; }
		...
		public SizeF GetIntrinsicSize(SizeF availableSize) => System.Maui.View.UseAvailableWidthAndHeight;
