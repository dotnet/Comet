...
{
	public class MauiTouchGestureListener : Java.Lang.Object, AView.IOnTouchListener
	{
		class GestureDetectorListener : Java.Lang.Object, GestureDetector.IOnGestureListener
		{
			...
			Dictionary<MotionEvent, MauiTouchGestureListener> dictionary = new Dictionary<MotionEvent, MauiTouchGestureListener>();
			public bool OnTouchEvent(MauiTouchGestureListener v, MotionEvent e)
			{
		...
		public MauiTouchGestureListener(AView view)
		{
			this.view = view;
