...
{
	public abstract class MauiActivity : AppCompatActivity, IOnBackStackChangedListener

	{
		...
		public void OnBackStackChanged()
		{
			...
			if (SupportFragmentManager.Fragments.Last() is MauiFragment fragment && SupportActionBar != null)
			{
