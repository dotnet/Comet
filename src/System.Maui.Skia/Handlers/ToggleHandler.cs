...
{
	public class ToggleHandler : SkiaAbstractControlHandler<Switch> {
		...
		public static new readonly PropertyMapper<Switch> Mapper = new PropertyMapper<Switch> (SkiaControl.Mapper) {
			[nameof (Switch.IsOn)] = MapIsOnProperty,
		};

		public static DrawMapper<Switch> ToggleDrawMapper = new DrawMapper<Switch> (SkiaControl.DrawMapper) {
		...
		public static void DrawThumb (SKCanvas canvas, RectangleF dirtyRect, SkiaControl control, Switch view)
		{
			var slider = control as ToggleHandler;
			slider?.DrawThumb (canvas, dirtyRect);
		}

		public static void DrawTrack (SKCanvas canvas, RectangleF dirtyRect, SkiaControl control, Switch view)
		{
			var slider = control as ToggleHandler;
