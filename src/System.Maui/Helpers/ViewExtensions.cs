...
namespace System.Maui
{
	public static class ViewExtensions
	{
		...
		public static T AddGesture<T>(this T view, Gesture gesture) where T : View
		{
			...
			view?.ViewHandler?.UpdateValue(System.Maui.Gesture.AddGestureProperty, gesture);
			return view;
		}
		public static T RemoveGesture<T>(this T view, Gesture gesture) where T : View
		{
			...
			view?.ViewHandler?.UpdateValue(System.Maui.Gesture.RemoveGestureProperty, gesture);
			return view;
		}
