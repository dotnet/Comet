...
namespace System.Maui
{
	public static class StateManager
	{
		...
		static Assembly MauiAssembly = typeof(BindingObject).Assembly;
		...
		static IEnumerable<INotifyPropertyRead> CheckForStateAttributes(object obj, View view)
		{
			...
			var fields = type.GetFields(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance).
				Where(x => (x.FieldType.Assembly == MauiAssembly && x.FieldType.Name == "State`1") || Attribute.IsDefined(x, typeof(StateAttribute))).ToList();
