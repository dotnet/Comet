...
namespace System.Maui
{
	public static class HotReloadHelper
	{
		...
		public static View GetReplacedView(View view)
		{
			...
			{
				Debug.WriteLine("You are using System.Maui.Reload on a view that requires Parameters. Please call `HotReloadHelper.Register(this, params);` in the constructor;");
				throw ex;
			}
