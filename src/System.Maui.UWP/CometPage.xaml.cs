...
namespace System.Maui.UWP
{
	public sealed partial class System.MauiPage : Page, IViewHandler
	{
		...
		public System.MauiPage()
		{
			Init();
		}

		public System.MauiPage(View view)
		{
			Init();
			View = view;
		}
		...
		System.MauiView System.MauiView;
		...
		private View View
		{
			...
			set
			{
				...
				_view = value;
				Content = System.MauiView =  (System.MauiView)_view.ToEmbeddableView();
				if (_view?.BuiltView is NavigationView nav)
				{
					...
					nav.SetPerformNavigate(toView => {
						...
						Frame.Navigate(typeof(System.MauiPage), toView);
