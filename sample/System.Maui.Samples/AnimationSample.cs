...
namespace System.Maui.Samples
{
	public class AnimationSample : View
	{
		...
		View Build() =>
			new VStack
			{
				new Label("Regular Text Behind..."),
				(animatedText = new Label("Text to Animate!")
				...
				new Label("Does this move?").Background(Color.LightBlue).Frame(width:100,height:44).Animate((text)=>{
